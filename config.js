window.SLOPRIME_CONFIG = {
  ...
  links: {
    ...
    join: "https://cfx.re/join/5oybeq7",
  ...
  gallery: [
    {
      title: "Nocturnal Skyline",
      text: "Premium city mood za resen roleplay svet."
    },
    {
      title: "High Command",
      text: "Frakcije, vodstva in resne RP situacije."
    },
    {
      title: "Cinematic Streets",
      text: "Od business zgodb do velikih nocnih eventov."
    },
    {
      title: "Elite Experience",
      text: "Platforma, ki je narejena za dolgorocno skupnost."
    }
  ]
};
